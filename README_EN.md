...
└── examples/                          # 15 persons + 1 topic, with full research data
    ├── steve-jobs-perspective/        # Steve Jobs (with demo conversation)
    ...
    └── x-mastery-mentor/             # X Mastery Mentor (topic skill)
```
